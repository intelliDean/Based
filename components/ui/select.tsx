...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & { onMouseDown?: (e: React.MouseEvent) => void }
>(({ className, children, onMouseDown, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    onMouseDown={onMouseDown} // Allow an optional onMouseDown to be passed
    {...props}
  >
    {children}
...
const SelectContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { onMouseDown?: (e: React.MouseEvent) => void }
>(({ className, children, position = "popper", onMouseDown, ...props }, ref) => (
